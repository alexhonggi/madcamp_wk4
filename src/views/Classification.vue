<template>
    <div class="wrapper" :style="{backgroundColor:backgroundcolor}">
        <transition-group>
            <div @mouseenter="changeBackground(0)" @click="clickevent(0)" class="firstblock" :class="transition[0]"></div>
            <div @mouseenter="changeBackground(1)" @click="clickevent(1)" class="secondblock" :class="transition[1]"></div>
            <div @mouseenter="changeBackground(2)" @click="clickevent(2)" class="thirdblock" :class="transition[2]"></div>
        </transition-group>        
    </div>
</template>
...
export default {
  ...
  data(){
    return{
        ...
        backgroundcolorList:["#f53844","#0b5ce2","#f5b338"],
