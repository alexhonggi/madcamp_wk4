...
<transition name="fade">
  <div id="demo" v-if="updated">
    ...
    <transition name="fade3">
      <p class = "nextBack" v-bind:key="show" v-if="!show"><div class="name">{{users[index].name}}</div><div class="job" :style="{backgroundColor:colorlist[index]}">{{users[index].profession}}</div><div class="topic">{{users[index].dream}}</div></p>
    </transition>
    <!-- 밑줄에 소개 -->
    <transition name="fade">
    ...
    <transition name="fade2">
      <p @click="pass = false" class = "beforeBack" v-bind:key="show" v-if="pass" :style="{backgroundColor:colorlist[index-1]}"><div class="name">{{users[index-1].name}}</div><div class="job">{{users[index-1].profession}}</div><div class="topic">{{users[index-1].dream}}</div></p>
    </transition>
    <transition name="fade2">
      <p @click="pass2 = false" class = "beforeBack" v-bind:key="show" v-if="pass2" :style="{backgroundColor:colorlist[index-1]}"><div class="name">{{users[index-1].name}}</div><div class="job">{{users[index-1].profession}}</div><div class="topic">{{users[index-1].dream}}</div></p>
    </transition>
  </div>
</transition>
</template>
